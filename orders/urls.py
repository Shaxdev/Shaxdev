...
urlpatterns = [
    ...
    path('update_order_item_status/<int:pk>/<str:status>', views.update_order_item_status, name='update_order_item_status'),
    ...
    path('create_pdf_file/<int:pk>', views.create_pdf_file, name='create_pdf_file'), 
]
